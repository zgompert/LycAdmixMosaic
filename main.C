...
// this version is for sex chromosomes

// Time-stamp: <Friday, 03 June 2016, 20:51 MDT -- zgompert>
...
int main(int argc, char *argv[]) {
  ...
  int rng_seed = 0;
  int ch, i;
  int nh = 0; // number of header lines, excluding the required headers:
  // nind nlocus
  // hap or dip for sex (1 or 2)
